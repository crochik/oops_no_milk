...
import { UserDesignAssociateAppProfilesInspireNetMobileProductSelectorSerializer } from './UserDesignAssociateAppProfilesInspireNetMobileProductSelectorSerializer';
import { UserRoleSerializer } from './UserRoleSerializer';

// Import derived type serializers (for polymorphic deserialization)

/**
 * Serializer for UserDesignAssociate - handles JSON serialization and deserialization with type validation
 */
export class UserDesignAssociateSerializer {
  /**
   * Deserializes a JSON string into a UserDesignAssociate instance
   */
  static deserialize(json: string): UserDesignAssociate {
    const obj = JSON.parse(json);
    return this.fromObject(obj);
  }

  /**
   * Deserializes a plain object into a UserDesignAssociate instance
   */
  static fromObject(obj: any): UserDesignAssociate {
    if (!obj) {
      throw new Error('Cannot deserialize null or undefined to UserDesignAssociate');
    }


    const instance: UserDesignAssociate = {
      ...
      appProfilesInspireNetMobileProductSelector: obj['AppProfiles|InspireNetMobile_ProductSelector'] as UserDesignAssociateAppProfilesInspireNetMobileProductSelector | undefined,
    };
  ...
  /**
   * Deserializes a JSON string into an array of UserDesignAssociate instances
   */
  static deserializeArray(json: string): UserDesignAssociate[] {
  ...
  /**
   * Serializes a UserDesignAssociate instance to a JSON string
   */
  static serialize(instance: UserDesignAssociate): string {
    return JSON.stringify(this.toObject(instance));
  }

  /**
   * Converts a UserDesignAssociate instance to a plain object
   */
  static toObject(instance: UserDesignAssociate): any {
    return {
      'name': instance.name,
      ...
      'AppProfiles|InspireNetMobile_ProductSelector': instance.appProfilesInspireNetMobileProductSelector,
    };
  }

  /**
   * Serializes an array of UserDesignAssociate instances to a JSON string
   */
  static serializeArray(instances: UserDesignAssociate[]): string {

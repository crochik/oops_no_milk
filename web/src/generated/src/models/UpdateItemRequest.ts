import { UpdateItemRequestSection } from './UpdateItemRequestSection';
import { UpdateItemRequestStatus } from './UpdateItemRequestStatus';
import { UpdateItemRequestUrgency } from './UpdateItemRequestUrgency';

/**
 * Request Body to Update A grocery-list entry in a household. Tracks urgency, section, status, and the users who added and purchased it.
 */
export interface UpdateItemRequest {
   ...
   */
  section?: UpdateItemRequestSection;
  /**
   ...
   */
  urgency?: UpdateItemRequestUrgency;
  /**

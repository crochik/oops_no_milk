...
/**
 * Input payload for the escalateStaleItems action. Names the household and optionally overrides the staleness threshold.
 */
export interface EscalateStaleItemsInput {
  /**

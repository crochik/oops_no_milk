import { CreateItemRequestSection } from './CreateItemRequestSection';
import { CreateItemRequestStatus } from './CreateItemRequestStatus';
import { CreateItemRequestUrgency } from './CreateItemRequestUrgency';

/**
 * Request Body to Create A grocery-list entry in a household. Tracks urgency, section, status, and the users who added and purchased it.
 */
export interface CreateItemRequest {
   ...
   */
  section: CreateItemRequestSection;
  /**
